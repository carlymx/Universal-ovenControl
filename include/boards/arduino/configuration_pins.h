...
#define ANALOG_BUTTON1      PIN_A0  // PUSH BUTTON INPUT
#define ANALOG_BUTTON2      PIN_A1  // PUSH BUTTON INPUT
#define ANALOG_BUTTON3      PIN_A2  // PUSH BUTTON INPUT
#define ANALOG_BUTTON4      PIN_A3  // PUSH BUTTON INPUT
